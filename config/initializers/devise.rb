...
Devise.setup do |config|
  ...
  config.mailer_sender = 'itan@gmail.com'
  ...
  # Tell Devise to generate email confirmation links pointing to your Next.js frontend
  # config.confirmation_url = ENV['EMAIL_CONFIRMATION_URL']
  # ==> ORM configuration
